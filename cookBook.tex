     ...
     \meal{Kung Pao Chicekn}
      ...
      \meal{Thai-Inspired Chicken Meatball Soup}
            ...
            {\begin{enumerate}    % Cooking Instructions
                  ...
                  \item In the mixing bowl, add meat, half the cilantro (finely chopped), salt and 2 tbps fish sauce. Mix with the previously added aromatics 
                  ...
                  \item Add spinach and cover to wilt. Meanwhile, zest and juice limes. Add to pot and serve over white rice 
            \end{enumerate}}
