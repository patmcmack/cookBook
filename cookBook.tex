...
% Use the command "sh pushAll.sh "Added jollof, gochujan, elote, peru""
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
      ...
      \meal{Chicken Curry}
            ...
            \end{itemize}}
            {\begin{enumerate}
                  \item Marinade chicken with oil, salt, 1 tbs turmeric, 1 tbs garam masala, 1/4 tbs cinnamon
      ...
      \meal{Fried Rice (cast iron method)}
            ...
            {\begin{enumerate}    % Cooking Instructions
                  ...
                  \item Return pork to pan, add peas and season to taste with soy sauce, oyster sauce, sesame oil, sriracha and MSG 
                  \item Garnish with sesame seeds and green onion. Serve warm 
      \end{enumerate}}     
      ...
      \meal{Elote street corn salad}
            ...
            {\begin{itemize}      % Ingredients
                  ...
                  \item green onion, sliced 
                  \item 2 jalape\~noss, finely diced 
      ...
      \meal{Gochujan Chicken}
            ...
            {\begin{enumerate}    % Cooking Instructions
                  ...
                  \item Adjust heat by adding more gochujan, can also add sesame oil
      ...
      \meal{Jollof rice and suya beef}
            ...
            {\begin{enumerate}    % Cooking Instructions
                  ...
                  \item Combine tomato, red bell pepper, habanero pepper, jalape\~noss chili, garlic, ginger, in a blender for the sauce. Blend on high until smooth. Adding enough water/chicken stock to match rice's desired amount of cooking liquid 
     ...
     \meal{Kung Pao Chicekn}
      ...
      \meal{Pad Ka-Prao}
            {Thai-style stir fried ground pork with basil. Serve over white rice and Nam Pla Prik}
            {5--7}                % Serving Size
            {\begin{itemize}      % Ingredients
                  \item 6 cloves garlic
                  \item 1--2 shallots 
                  \item 2--3 onions, diced
                  \item 4--8 thai bird's eye chiles 
                  \item 4 lbs ground pork 
                  \item 2--3 lbs green beans 
                  \item 3 tbps fish sauce 
                  \item 1 tps palm/brown sugar 
                  \item 2 tbps dark soy sauce 
                  \item 2 tbps oyster sauce 
                  \item 2 cups (packed) thai basil 
            \end{itemize}}
            {\begin{enumerate}    % Cooking Instructions
                  \item  Dice onions, chop beans into sections, mince garlic and dice chilies. 
                  \item In a large wok over high heat, brown off pork (1 lbs) for 2--4 minutes. Add 1/4th beans and cook for another few minutes. Then add 1/4th onion, chiles and garlic. 
                  \item When onions are soft, add sugar, some fish sauce, soy sauce and oyster sauce. Stir for another minute 
                  \item Remove from heat and add 1/4th sliced basil, stir in and allow to wilt from carryover heat.
                  \item Repeat in batches until all meat and veggies are cooked 
                  \item Serve over rice and nam pla prik 
            \end{enumerate}}
      ...
      \meal{Nam Pla Prik}
            ...
            {5--7}                % Serving Size
            {\begin{itemize}      % Ingredients
                  \item 10--30 thai bird's eye chiles
                  \item 2--4 garlic cloves 
                  \item 2 tbps palm/brown sugar 
                  \item 1/2 cup fish sauce
                  \item 2--4 limes 
            \end{itemize}}
            {\begin{enumerate}    % Cooking Instructions
                  \item  Zest and juice limes, add to bowl with fish sauce 
                  \item Finely slice garlic and chiles, add to bowl with sugar and stir 
            \end{enumerate}}

      \meal{Dal}
            {Indian lentil curry, serve with a yogurt and naan}
            {5--7}                % Serving Size
            {\begin{itemize}      % Ingredients
                  \item 2 bags (lbs) red lentils 
                  \item 4 onions, diced
                  \item 3 inch knob ginger, grated 
                  \item 4 cloves garlic 
                  \item 2 cans coconut milk 
                  \item 10--12 cups broth 
                  \item 1--2 cups chopped/crushed tomatoes
                  \item 2 tpbs lemon juice 
                  \item coconut sugar to taste 
                  \item 3--4 jalape\~noss
                  \item 2 tbps curry powder 
                  \item 2 tbps turmeric
                  \item 2 tbps mustard seeds 
                  \item 2 tps cumin 
                  \item 1 tbps ground coriander 
                  \item 2 tps paprika 
                  \item 1 tpbs garam masala 
                  \item plain yogurt 
                  \item cilantro
            \end{itemize}}
            {\begin{enumerate}    % Cooking Instructions
                  \item Soak lentils in water overnight, drain
                  \item Add onions to large pot and cook until translucent. Add garlic and ginger, cook for another 3 minutes 
                  \item Add all spices and bloon for an additional 2 minutes 
                  \item Add lentils and broth, bring to a simmer and cook for 10--15 minutes 
                  \item Add coconut milk and tomatoes, cook for another 10 minutes 
                  \item Season to taste with salt, sugar and lime juice 
                  \item Stir in cilantro, serve with yogurt and naan 
            \end{enumerate}}

      \meal{Beans and greens pasta with sausage and mushroom}
            {Baked pasta dish, a mix of multiple multiple \href{https://www.seriouseats.com/cast-iron-cooking-crispy-baked-pasta-mushrooms-sausage-parmesan-cream-sauce-recipe}{Serious} \href{https://www.seriouseats.com/pasta-with-beans-and-greens}{Eats} recipes}
            {7--9}                % Serving Size
            {\begin{itemize}      % Ingredients
                  \item 1.5 lbs dry pasta 
                  \item 1.5 cups panko bread crumbs 
                  \item 1 cup grated parm 
                  \item 1/2 cup parsley leaves, chopped 
                  \item 4 tpbs chives, chopped 
                  \item 3--4 onions, diced 
                  \item 4 cloves garlic
                  \item 2--4 lbs ground italian sausage
                  \item 2 lbs mushrooms, sliced 
                  \item 2 tbps soy sauce
                  \item 1 tbps lemon juice
                  \item 3--4 tbps flour 
                  \item 2 cups stock
                  \item 1 cup white wine 
                  \item 1 cup heavy cream 
                  \item 2 cans cannellini beans 
                  \item 1 bunch kale, chopped 
                  \item 1 large bag spinach
            \end{itemize}}
            {\begin{enumerate}    % Cooking Instructions
                  \item In large skillet, brown off sausage in batches over high heat
                  \item In the same skillet, cook mushrooms while scraping up any fond that developed on the bottom of the pan.
                  \item Add onions and garlic, cook for 3--5 minutes and then add soy sauce, lemon juice and wine. Cook until liquid is nearly completely reduced 
                  \item Return sausage to pan, add stock and let simmer. Add beans (with some can liquid) and greens, cover and cook for about 10 minutes. Meanwhile cook pasta 2 minutes short of al dente
                  \item  Meanwhile, combine panko, 1/3 of the cheese, 1/2 of the chives and parsley in a bowl with salt and pepper 
                  \item Add pasta to skillet with remainign parsley, chives and cheese. Stir in cream and cook until pasta reaches aldente. Adjust thickness with pasta water. Taste for seasoning 
                  \item Remove from heat, add panko mix over top and bake at 400 for 5--10 minutes, broil as necessary to brown top 
            \end{enumerate}}


      \meal{Chicken Riggies}
            {Utica classic. Basically vodka sauce with chicken and hot peppers}
            {7--9}                % Serving Size
            {\begin{itemize}      % Ingredients
                  \item 1.5 lbs rigatoni 
                  \item 3 lbs chicken thighs
                  \item 3 clvoes garlic 
                  \item 3--5 red/orange bell peppers 
                  \item 1--2 lbs mushrooms, chopped 
                  \item 5--6 jarred hot peppers, chopped 
                  \item 2--3 fire roasted jarred peppers, chopped 
                  \item 28--42oz crushed tomatoes
                  \item 1 cup basil, chopped 
                  \item 1.5 cup red wine 
                  \item 1.5 cups heavy cream 
                  \item 2 tbps red pepper flakes 
                  \item 1 cup pecorino romano cheese, grated 
                  \item 1 cup parsley, chopped 
            \end{itemize}}
            {\begin{enumerate}    % Cooking Instructions
                  \item  Season chicken with salt and pepper and then brown in batches in large pot.
                  \item Remove chicken, add mushrooms and cook over high heat. When done add fresh and jarred tomatoes and cook until soft. 
                  \item Add garlic, red pepper flakes and cook for another 1--2 minutes. Add wine and cook until nearly dry
                  \item Add tomatoes and simmer for 5--10 mintues, meanwhile chop chicken into bite-sized pieces 
                  \item Add cream to sauce, cook until it thickens
                  \item Cook pasta 1--2 minutes short of al dente. Add to pot with sauce to finish cooking. Add chicken back and adjust thickness with pasta water 
                  \item Add cheese, basil and parsley. Serve immediately
            \end{enumerate}}

      \meal{Lohikeitto}
            {Finnish salmon soup (chowder). Serve with buttered toast}
            {5}                % Serving Size
            {\begin{itemize}      % Ingredients
                  \item 3--4 lbs salmon fillets
                  \item 4 tbps butter 
                  \item 3--4 leeks 
                  \item 6 cups fish stock 
                  \item 2--3 lbs potatoes 
                  \item 4--6 large carrots 
                  \item fresh dill 
                  \item 2 cups heavy cream 
                  \item 1 tsp allspice 
                  \item salt/pepper 
            ...
            \end{itemize}}
            {\begin{enumerate}    % Cooking Instructions
                  \item  Chop and wash leeks, cook until soft in large dutch over with butter over medium heat
                  \item Meanwhile, cube potates and carrots. Add to pot with 6 cups stock. Add allspice and half of the dill (optionally bay leaves). Simmer for 10--15 minutes, until just starting to soften.
                  \item Remove skin from salmon and cube. Add to pot with cream and gently simmer until cooked. Approximatly 5 minutes.  
                  \item Add remaining dill and lemon zest. Serve with sliced lemon 
            \end{enumerate}}

      \meal{Ramen}
            {Recipe is for one bowl, scale up as needed}
            {1}                % Serving Size
            {\begin{itemize}      % Ingredients
                  \item pork loin (roasted)
                  \item egg (medium boiled)
                  \item cabbage (shredded)
                  \item carrots (shredded)
                  \item bean sprouts 
                  \item garlic/ginger paste 
                  \item 1 tps sriracha
                  \item 1/2 tps hondashi 
                  \item 1 pinch bonito flakes 
                  \item 1 tpbs soy sauce 
                  \item 1 tps sesame oil 
                  \item 1 tpbs miso paste 
                  \item 1 tpbs gochujan
                  \item 1 serving dried ramen 
                  \item kimchi 
                  \item 3--4 cups stock
            \end{itemize}}
            {\begin{enumerate}    % Cooking Instructions
                  \item  Make Myaka eggs (soy sauce marinaded eggs) by medium boiling (10 mins) and peeling eggs. Marinade overnight in fridge with 1/2 cup soy sauce, 1/2 cup water, 1 tps sesame oil, 2 chopped garlic cloves, green onions and splash of rice vinegar
                  \item Add a halfed egg, a flew thin slices of pork and all other ingredients (besides noodles) to a heatproof bowl.
                  \item Bring 3--4 cups water/stock to a boil and add noodles for 30 seconds. 
                  \item Pour noodles and hot water over all ingredients in bowl. Stir and let stand for 1 minute before eating 
            \end{enumerate}}

      \meal{Carnitas con frijoles y salsa verde}
            {Heat corn tortillas in microwave with wet paper towl}
            {8}                % Serving Size
            {\begin{itemize}      % Ingredients
                  \item 6--8 lbs pork sholder 
                  \item 2--3 oranges 
                  \item 4--6 onions 
                  \item 3 tpbs cumin 
                  \item salt/pepper 
                  \item corn tortillas
                  \item 4 cans black beans 
                  \item cilantro (2x)
                  \item 6--8 cloves garlic 
                  \item cotija or feta cheese 
                  \item 5--8 jalapeños
                  \item 4--6 poblanos
                  \item 1--2 dozen tomatillos
                  \item 2--3 limes 
            \end{itemize}}
            {\begin{enumerate}    % Cooking Instructions
                  \item  Slowcook pork shoulder on low for 8 hours with salt/pepper, 3--4 sliced onions, 2 tpbs cumin, and the juice/zest of the oranges
                  \item For the salsa verde, cut the chiles in half, scrape out and discard the seeds. Husk the tomatillos, rinse, and cut them in half. Roughly cut other onion. Put the veggies and lime into a wide pan and toss them in olive oil. Put the pan into the oven at 450 F. After the salsa has a bit of color, put in the whole peeled garlic cloves and stir. Cook maybe 20 mins total. Broil for a few minutes on high, Squeeze the lime juice and zest. Puree with cilantro until smooth.
                  \item For the beans, finely chop 2 onions and cook until soft. Add 2--3 diced cloves garlic and 1 tpbs cumin and cook an additional minute. Add undrained beans and simmer until reduced, stirring frequently (about 20 minutes). Garnish with chopped cilantro and crumbled cheese
                  \item After 8 hours, shred pork and broil on high  on sheetpan until crisp. Stir meat and return to broiler an additional time or two 
                  \item Serve with warmed tortialls with salsa verde on the side 
            \end{enumerate}}

      \meal{Chicken Pot Pie with Biscuits}
            {From \href{https://www.seriouseats.com/chicken-pot-pie-biscuit-topping-recipe}{SeriousEats}. Feel good food}
            {5--7}                % Serving Size
            {\begin{itemize}      % Ingredients
                  \item rotisserie chicken, shredded 
                  \item 1 pint cups stock
                  \item 1 cup white wine 
                  \item 1 package gelatin 
                  \item 1.5 sticks butter 
                  \item 2--3 cups flour 
                  \item 2 onions, diced
                  \item 4--5 carrots, diced 
                  \item 1 head celery, diced
                  \item 2 cloves garlic
                  \item 2 cups frozen peas 
                  \item 2 tbps worcestershire
                  \item 1 tbps thyme
                  \item 1 tbps rosemary
                  \item bay leaves 
                  \item 15--30 grams sugar 
                  \item 1 tbps baking powder 
                  \item 1--2 cups buttermilk 
                  \item salt/pepper 
            \end{itemize}}
            {\begin{enumerate}    % Cooking Instructions
                  \item  Shred chicken, save bones for stock making. Combine gelatin and 1/4 cup of water/stock, wisk well and set aside 
                  \item In pot, make roux with half stick of butter and 3/4--1 cup flour. Stir and cook for 5--10 minutes or until nutty
                  \item Add carrots, onion, celery and cook until begining to soften. Then add bay leaves, garlic, thyme and rosemary. Cook for another 60 seconds
                  \item Add wine, stir well and cook until almost dry. Then add stock and worcestershire. Add chicken, peas, gelatin and cook gently for at least 10 minutes
                  \item Meanwhile, add diced, cold butter to large bowl. Then add 250g flour, 6g salt, 15--30g sugar, and 1 tbps baking powder. Cut butter into dry mixture with pastry cutter. Then fold 225g buttermilk into mixture. Adjust with more liquid or flour 
                  \item  Add chicken filling to baking dish, then scoop small dough balls on top in a grid pattern, bake at 400 for 45--60 minutes 
            \end{enumerate}}
            
      \meal{Broccoli Cheese Soup}
            {From J Kenji Lopez-Alt. Serve with toast}
            {5--7}                % Serving Size
            {\begin{itemize}      % Ingredients
                  \item 4--6 crowns of broccoli
                  \item 3 tbps butter 
                  \item 2 onions, diced 
                  \item 2--4 carrots, diced 
                  \item 3 cloves garlic 
                  \item 1 pint stock 
                  \item 3 cups whole milk 
                  \item 2 russet potatoes 
                  \item 12oz sharp chedder cheese 
                  \item 8oz american cheese 
                  \item 1 tps mustard powder 
                  \item 1 tpbs hot sauce 
            \end{itemize}}
            {\begin{enumerate}    % Cooking Instructions
                  \item  Cut broccoli florets into bite-sized pieces, dice stems 
                  \item Toss florets in oil, salt/pepper and roast at 430 degrees until starting to crisp 
                  \item In large pot, melt butter and begin cooking diced stems, onions and carrots. Add garlic in final 60 seconds of cooking 
                  \item Add stock, milk and diced potatoes and bring to a simmer. Cook until broccoli and potoates are completely tender 
                  \item With an immersion blender, blend until completely smooth 
                  \item In batches, blend in cheese. Add mustard powder, hot sauce and season to taste 
                  \item Add roasted broccoli and serve with bread 
            \end{enumerate}}

      \meal{Thai-Inspired Chicken Meatball Soup}
            {NYT recipe. Not traditional. Serve with white rice and green beans}
            {5--7}                % Serving Size
            {\begin{itemize}      % Ingredients
                  \item 4 lbs ground chicken/turkey (85\%)
                  \item 4 inch knob ginger 
                  \item 1 head garlic 
                  \item 2 jalapeños
                  \item 1 bunch cilantro
                  \item 1 bunch basil 
                  \item 1 cup breadcrumbs
                  \item 5--6 bell peppers, diced  
                  \item 1 tbps birds-eye peppers 
                  \item 3 onions, diced 
                  \item 3--5 tbps fish sauce
                  \item 2--3 cups stock 
                  \item 3 cups coconut milk 
                  \item 1 tbps sugar 
                  \item 10oz spinach
                  \item 3 limes 
            \end{itemize}}
            {\begin{enumerate}    % Cooking Instructions
                  \item  Peel and grate ginger, garlic and finely dice jalapeños and birds-eye. Add half to large mixing bowl and reserve other half for later. 
                  \item In the mixing bowl, add meat, half the cilantro (finely chopped), salt, breadcrumbs and 2 tbps fish sauce. Mix with the previously added aromatics 
                  \item Form 2 inch meatballs onto a baking sheet. Then in a preheated dutch oven, brown all the meatballs on 2--3 sides. Work in batches, do not need/want to fully cook meat at this stage 
                  \item Remove the meatballs and use the onions and peppers to scrape up the fond on the bottom of the pot. Cook until soft, adding the second half of the aromatics in the final 60 seconds. 
                  \item Add sugar, stock, coconut milk and bring to a simmer. Add back meatballs and cook until done ($\sim$10 minutes) 
                  \item Add spinach and cover to wilt. Meanwhile, zest and juice limes. Add to pot with basil and serve over white rice 
            \end{enumerate}}

      \meal{Greek chicken bowl}
            {Serve with pita/naan bread}
            {6--7}                % Serving Size
            {\begin{itemize}      % Ingredients
                  \item 4--5 lbs chicken thighs
                  \item 3--4 onions 
                  \item 3--4 bell peppers 
                  \item 3--4 zucchini (optional)
                  \item feta 
                  \item 1 tbps onion powder
                  \item 1 tbps garlic powder
                  \item 1 tbps thyme
                  \item 1 tbps basil 
                  \item 1 tbps onion oregano
                  \item 3--4 cups quinoa or bulgur wheat 
                  \item chopped mint 
                  \item chopped parsley 
                  \item coriander
                  \item 5--6 cucumbers 
                  \item handful cherry tomatoes 
                  \item 3--4 lemons 
                  \item green onion
                  \item dill 
                  \item olive oil
            ...
            \end{itemize}}
            {\begin{enumerate}    % Cooking Instructions
                  \item  Marinade chicken with onion powder, garlic powder, thyme, basil oregano, salt/pepper with some mayo and oil. Set sit for a few hours, then grill 
                  \item Cook quinoa or bulgur wheat as per package directions, then add 1--2 finely chopped cucumbers, tomatoes, parsley, green onion, mint, lemon zest/juice, coriander and olive oil
                  \item Make tzatziki by combining yogurt, grated cucumbers (, no skin, middles removed), garlic, dill, salt, lemon juice/zest and olive oil.
                  \item Serve with feta and warmed bread 
            \end{enumerate}}

      \meal{Turmeric-Black Pepper Chicken With Asparagus}
            {From NYT, serve over rice. Cook in wok or large cast iron pan}
            {6--7}                % Serving Size
            {\begin{itemize}      % Ingredients
                  \item 4--5 lbs chicken thighs 
                  \item 8 tps honey 
                  \item salt
                  \item 4 tps black pepper
                  \item 3 tps turmeric 
                  \item 8 tbps flour 
                  \item 2--4 onions, diced 
                  \item 2 bunches asparagus, chopped 
                  \item 1 tps rice vinegar
                  \item 1 tps soy sauce 
            \end{itemize}}
            {\begin{enumerate}    % Cooking Instructions
                  \item  In a small bowl or measuring cup, stir together 1 cup water with the honey, pepper and ½ teaspoon salt; set honey mixture aside.
                  \item In a medium bowl, stir together the flour, turmeric and 1 teaspoon salt. Add the chicken and toss until coated
                  \item In a large skillet or wok, heat the oil over medium-high. Add the chicken and cook until the turmeric is fragrant and the chicken is golden brown on both sides 
                  \item Add the asparagus and onion, season with salt, stir to combine and cook until crisp-tender, 1 to 2 minutes.
                  \item Add the honey mixture and cook, stirring, until the chicken is cooked through and the sauce has thickened, 2 to 3 minutes
                  \item Remove from heat and stir in the vinegar/soy sauce. Season to taste with salt and pepper. Serve with lime squeezed over top
            \end{enumerate}}

      \meal{Orange chicken (gringo style)}
            {From Adam Ragusea, serve over rice. Cook in wok or large cast iron pan}
            {5--8}                % Serving Size
            {\begin{itemize}      % Ingredients
                  \item 4--5 lbs chicken thighs, diced 
                  \item 3--4 heads broccoli
                  \item 4 tbps soy sauce 
                  \item 4 tbps rice vinegar
                  \item 4--6 large oranges 
                  \item 3--4 onions, diced 
                  \item 3--4 cloves garlic 
                  \item MSG
                  \item knob ginger 
                  \item hot peppers, diced 
                  \item salt/pepper 
                  \item 1/2 cup cornstarch 
                  \item 1/2 cup flour (optional)
            \end{itemize}}
            {\begin{enumerate}    % Cooking Instructions
                  \item Chop and dice broccoli. Toss with oil, salt and pepper. Roast at 425 for 30--45 mintues, tossing halfway through
                  \item  Season diced chicken with salt and pepper, then coat in cornstarch (and flour) on a large sheetpan 
                  \item Make sauce by combining orange juice, soy sauce, rice vinegar, 1/2 cup water, pinch of sugar, grated ginger, grated garlic and MSG 
                  \item In large pan or wok, cook chicken on high heat, browning well in batches. When almost done, add onions and peppers. When chicken is fully cooked, all in liquid and allow to thicken 
                  \item Serve over rice with orange zest 
            \end{enumerate}}

      \meal{Dense bean salad}
            {Very easy, no cooking}
            {10}                % Serving Size
            {\begin{itemize}      % Ingredients
                  \item 1--2 rotisserie chickens, shredded 
                  \item 6--8 bell peppers, diced 
                  \item 5 avacados 
                  \item 4--6 limes
                  \item 1 can chipotle in adobo 
                  \item 2--3 cloves garlic 
                  \item 1 tbps mustard 
                  \item olive oil 
                  \item 4--6 tbps mayo 
                  ...
                  \item green onion
                  \item cilantro
                  \item 4--6 jalapeños, diced 
                  \item 2--4 tbps vinegar
                  \item 1 tbps cumin 
                  \item 2 cans kidney beans 
                  \item 2 cans black beans 
                  \item 1--2 cans chickpeas 
                  \item 2 cans white northern beans 
                  \item 1--2 cans pinto beans 
                  \item 1 can fire-roasted tomatoes
                  \item 4--5 ears corn 
            \end{itemize}}
            {\begin{enumerate}    % Cooking Instructions
                  \item  Grill or roast corn, then remove from cob and add to your largest bowl 
                  \item Add chicken, all beans, tomatoes, red onion, green onion, cilantro, bell peppers and jalapeños
                  \item Make dressing in blender with mayo, oil, chipotles in adobo, lime juice/zest, vinegar, mustard, salt/pepper/msg and cumin. Optionally thin out with water 
                  \item Mix dressing over everything. Serve with freshly diced avacado
            \end{enumerate}}

      \meal{Thai Coconut Chicken and Rice}
            {From NYT, not traditional.}
            {5--7}                % Serving Size
            {\begin{itemize}      % Ingredients
                  \item 4 lbs chicken thighs
                  \item 2 inch knob ginger (ground to paste)
                  ...
                  \item 3 cups coconut milk 
                  \item 3--5 cups stock 
                  \item 3 bell peppers, diced 
                  \item 3 onions, diced
                  \item 1 cup roasted cashews, chopped 
                  \item green onions 
                  \item 1 bunch cilantro 
                  \item 2 tbps fish sauce 
                  \item 1 tbps birdseye chilies 
            \end{itemize}}
            {\begin{enumerate}    % Cooking Instructions
                  \item  Season each piece of chicken with salt/pepper. Then brown in a large dutch oven. Work in batches over medium-high heat, get good color but don't worry about fully cooking the meat 
                  \item Remove chicken from pot, add ginger and the garlic to the empty pot, and stir until fragrant, 30 seconds. Add rice and stir until evenly coated in the oil. Add broth, coconut milk, bell pepper, cashews, scallions, fish sauce and salt/pepper. Stir to lift up any browned bits on the bottom of the pot. Arrange chicken on top, add any accumulated juices from the plate and bring to a boil over high.
                  \item Cover and bake at 375 degrees until all of the liquid is absorbed, rice is tender and chicken is cooked through, 25 minutes. Scatter cilantro over the chicken and rice, then divide among bowls. Serve with hot sauce.
            \end{enumerate}}

      \meal{Chicken meatball soup}
            {Italian-style chicken soup. Serve with bread}
            {12}                % Serving Size
            {\begin{itemize}      % Ingredients
                  \item 6 lbs ground turkey (85\%)
                  \item 10--12 cups chicken stock 
                  \item 2--4 cups breadcrumbs
                  \item 1 tbps oregano
                  \item 4 tbps chives 
                  \item 2 eggs 
                  \item 1/4 cup milk 
                  \item 1 tbps garlic powder 
                  \item 1 tpbs onion powder 
                  \item 1 bunch celery
                  \item 5--8 large carrots 
                  \item 3--4 onions 
                  \item 2 bay leaves 
                  \item 4 tpbs tomato paste 
                  \item 3--5 cloves garlic 
                  \item 1 jar sliced sundried tomatoes 
                  \item 2--3 cups heavy cream 
                  \item 2--4 cups shredded parmesan
                  \item 1 tbps thyme 
                  \item 2 tbps basil 
            ...
            \end{itemize}}
            {\begin{enumerate}    % Cooking Instructions
                  \item  Make the meatballs by combining meat, onion/garlic powder, chives, breadcrumbs, eggs and milk. Roll out onto sheetpan. 
                  \item In batches, fry off the meatballs in large dutch oven. Brown 2--3 sides, don't worry about them not being fully cooked yet. 
                  \item Remove meat from pot. Add in diced onions, carrots and celery. Sweat down, then add garlic. Optionally add some wine and cook out. Then add tomato paste and cook until almost burning, then deglaze with stock. Add bay leaves 
                  \item Add thyme (optional rosemary) and sundried tomatoes. Bring to a simmer and return meatballs to pot. 
                  \item Simmer until meatballs just reach 165 degrees (about 10--20 minutes). 
                  \item Then add spinach and cover pot to wilt for 5 minutes. 
                  \item Over low heat, stir in cream, parmesan, basil and parsley
            \end{enumerate}}


      \meal{Chicken Paprikash}
            {Serve over egg noodles. Use the expensive paprika.}
            {5--7}                % Serving Size
            {\begin{itemize}      % Ingredients
                  \item 4 lbs bone/skin-on chicken thighs
                  \item 1 packet powdered gelatin
                  \item 2 cups stock 
                  \item 2--4 onions 
                  \item 3--5 bell peppers 
                  \item 1/2 cup sweet paprika 
                  \item 2 bay leaves 
                  \item 1 cup sour cream 
                  \item 1 lbs egg noodles 
                  \item 1 tbps fish sauce 
                  \item 1 lemon plus zest 
                  \item 1 bunch dill 
                  \item 1 bunch parsley
            \end{itemize}}
            {\begin{enumerate}    % Cooking Instructions
                  \item  Season chicken with salt and pepper, then brown hard (skin side down first) is large pot. Work in batches. Chicken shouldn't be fully cooked.
                  \item Remove chicken from pot. Using the leftover fat, cook down onions and peppers. Add paprika in last minute.
                  \item Deglaze with stock and gelatin, then return chicken to pot. Simmer for about 30 minutes. 
                  \item Remove cooked chicken, then add lemon juice, zest, fish sauce, sour cream, dill and parsley.
                  \item Serve over egg noodles with chicken on top. 
            \end{enumerate}}

      \meal{Tomato Soup}
            {Serve with toasted sandwhiches}
            {10}                % Serving Size
            {\begin{itemize}      % Ingredients
                  \item 3--4 lbs whole tomatoes
                  \item 3--4 red bell peppers 
                  \item 4 sweet onions 
                  \item 1 tbps sugar 
                  \item 1 tpbs fish sauce 
                  \item 1--2 cups heavy cream 
                  \item 3--4 tbps tomato paste 
                  \item 2--3 cups fresh basil 
                  \item 2 tpbs oregano 
                  \item pinch of red pepper flakes 
                  \item 1 head garlic 
                  \item bay leaf
                  \item 4--6 cups stock 
                  \item ham pieces (optional)
                  \item salt/pepper
                  \item sherry vinegar (optional)
            \end{itemize}}
            {\begin{enumerate}    % Cooking Instructions
                  \item  Slice onions, and caremelize in large pot over low temp for about 2 hours. Add splashes of water to help regulate. 
                  \item Slice bottom off of garlic head, then add a bit of oil to the exposed top. Cover in foil and roast for at least an hour. 
                  \item Half and roast all fresh tomatoes and bell peppers at 425 degrees for 30--40 minutes. Develop color, broiling at the end if required. 
                  \item Any frozen tomatoes should be drained and then simmered in large pot on stove. 
                  \item Combine fresh/frozen veggies with tomato paste. Squeeze out the garlic head and add onions. Blend until smooth, adding your stock as necessary. Add remaining stock as desired. 
                  \item Season with oregano, red pepper flakes, fish sauce, bay leave and simmer for 20 mins. 
                  \item Add heavy cream, adjust seasoning and add vinegar/sugar as necessary. 
                  \item Stir in finely sliced basil and serve with warm sandwhich
            \end{enumerate}}

      \meal{Split Pea Soup}
            {Can sub smoked turkey legs instead of ham hocks. Serve with toast}
            {10}                % Serving Size
            {\begin{itemize}      % Ingredients
                  \item 2 lbs dry split peas 
                  \item 2 smoked ham hocks 
                  \item 2 lbs ham steak 
                  \item 3--4 onions, diced 
                  \item 1 head celery, diced
                  \item 4--6 carrots, diced
                  \item 2--4 cloves garlic 
                  \item 12--16 cups stock 
                  \item bay leaves 
                  \item 3 tbps butter
                  \item salt/pepper 
            \end{itemize}}
            {\begin{enumerate}    % Cooking Instructions
                  \item  In large pot, melt butter and cook onions, carrots and celery until soft. Add garlic in final 60 seconds of cooking 
                  \item Add ham hocks and ham steaks, bay leaves and stock. Bring to simmer 
                  \item Add peas (rinsed), salt/pepper and cook on low for 1 hour. 
                  \item Pull ham hocks, shred and return meat to pot. Discard bones 
                  \item Taste for seasoning, serve with toast 
            \end{enumerate}}

      \meal{Harissa Salmon}
            {Serve with roast asparagus and risotto}
            {2}                % Serving Size
            {\begin{itemize}      % Ingredients
                  \item 2 lbs salmon fillets 
                  \item 1 cup mayo 
                  \item 2--3 tbps hot harissa paste 
                  \item 2 limes, juiced and zested 
                  \item 1/2 tps ground coriander 
                  \item salt/pepper
            \end{itemize}}
            {\begin{enumerate}    % Cooking Instructions
                  \item  In a bowl, mix mayo, harissa, lime juice, zest and coriander. Add salt/pepper 
                  \item On baking sheet, dry off salmon and coat in mixture 
                  \item Cook under broiler for 5--10 minutes. Cover with foil if browning too much. Salmon should reach about 125--130 degrees internally. 
            \end{enumerate}}

      \meal{Coconut-Miso Salmon Curry}
            {From NYT. Serve over white rice}
            {8--10}                % Serving Size
            {\begin{itemize}      % Ingredients
                  \item 3--4 lbs salmon fillets
                  \item 4 tbps butter 
                  \item 3--4 red onions, sliced 
                  \item 2--4" knob ginger
                  \item 3--5 cloves garlic 
                  \item 3/4 cup white miso 
                  \item 1 cup coconut milk 
                  \item 8--12 cups stock
                  \item 15 oz baby spinach
                  \item 2--4 limes, juiced and zested 
                  \item white rice 
                  \item basil
                  \item cilantro
            \end{itemize}}
            {\begin{enumerate}    % Cooking Instructions
                  \item  In large pot, cook onions, ginger and garlic until soft with butter. Add miso and cook until lightly caramelized 
                  \item Add coconut milk and about stock. Bring to simmer and cook down for 5--10 minutes 
                  \item Stir in diced salmon and cook over low heat until done, about 5 minutes. Add salt/pepper
                  \item Turn off heat and add spinach and lime juice 
                  \item Serve over white rice, garnish with zest, basil and cilantro
            \end{enumerate}}
            

      \meal{Pizza Beans (Spicy Tomato Beans and Greens)}
            {Serve with a few slices of toast }
            {12}                % Serving Size
            {\begin{itemize}      % Ingredients
                  \item 8 cans canellini beans 
                  \item 6 bell peppers 
                  \item 4 onions 
                  \item 6 cloves garlic 
                  \item 2 lbs sausage
                  \item 1/2 cup tomato paste 
                  \item 3 tbps red pepper flakes 
                  \item 1 cup heavy cream 
                  \item 1 jar sun-dried tomatoes, chopped 
                  \item 3 cups grated parm 
                  \item 2 packages arugula 
                  \item 4 lemons 
                  \item basil
                  \item thyme 
                  \item salt/pepper
            \end{itemize}}
            {\begin{enumerate}    % Cooking Instructions
                  \item  In large pot, brown sausage while breaking up into small pieces. Then add diced onions and peppers, cook until soft 
                  \item Add diced garlic, sun-dried tomatoes and cook 2--3 minutes. Then add tomato paste. Cook until begining to burn 
                  \item Add in beans (drained, rinsed), 1/2 cup water, and red pepper flakes. Mix and cook for a couple of minutes, scrape up fonde
                  \item Lower heat, add heavy cream, basil, thyme, salt/pepper. Cook about 5 mintues then stir in 2 cups grated parm 
                  \item Make salad dressing with lemon zest, juice, olive oil, mustard and optionally mayo. Stir well 
                  \item To serve, mix dressing with arugula. Serve beans over toasted bread 
            \end{enumerate}}
